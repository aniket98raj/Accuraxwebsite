import svgPaths from "./svg-hlsbhnyqgy";
...
function Container1() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[361.152px]" data-name="Container">
...
function Div1() {
  return (
    <div className="h-[85.99px] relative shrink-0 w-[102.585px]" data-name="div">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Target />
        <P1 />
        <P2 />
...
function Div8() {
  return (
    <div className="h-[496.186px] relative shrink-0 w-[568.001px]" data-name="div">
...
function Card6() {
  return (
    <div className="absolute bg-black content-stretch flex flex-col gap-[47.994px] h-[605.587px] items-start left-0 pb-[0.707px] pl-[16.705px] pr-[0.707px] pt-[16.705px] rounded-[14px] top-0 w-[601.411px]" data-name="Card">
...
function Td() {
  return (
    <div className="absolute h-[48.702px] left-0 top-0 w-[34.084px]" data-name="td">
...
function Div10() {
  return (
    <div className="absolute content-stretch flex gap-[4px] h-[15.998px] items-center left-[8px] top-[16.35px] w-[82.698px]" data-name="div">
      <TrendingUp2 />
      <Span2 />
    </div>
  );
...
function Td1() {
  return (
    <div className="absolute h-[48.702px] left-[34.08px] top-0 w-[98.696px]" data-name="td">
      <Div10 />
    </div>
  );
}
...
function Td2() {
  return (
    <div className="absolute h-[48.702px] left-[132.78px] top-0 w-[127.532px]" data-name="td">
      <p className="-translate-x-full absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-[119.86px] not-italic text-[12px] text-right text-white top-[17.06px]">₹200.00</p>
    </div>
  );
}
...
function Td3() {
  return (
    <div className="absolute h-[48.702px] left-[260.31px] top-0 w-[104.949px]" data-name="td">
      <p className="-translate-x-full absolute font-['Inter:Bold',sans-serif] font-bold leading-[16px] left-[97.92px] not-italic text-[#05df72] text-[12px] text-right top-[15.72px]">+₹170.00</p>
    </div>
  );
}
...
function Td4() {
  return (
    <div className="absolute h-[48.702px] left-[365.26px] top-0 w-[127.61px]" data-name="td">
      <p className="-translate-x-full absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[119.71px] not-italic text-[12px] text-right text-white top-[17.06px]">₹10170.00</p>
    </div>
  );
}
...
function Td5() {
  return (
    <div className="absolute h-[48.702px] left-[492.87px] top-0 w-[107.126px]" data-name="td">
      <p className="-translate-x-full absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-[99.6px] not-italic text-[#99a1af] text-[12px] text-right top-[17.06px]">1:11:16 PM</p>
    </div>
  );
}
...
function Th() {
  return (
    <div className="absolute bg-black h-[40.349px] left-0 top-0 w-[34.084px]" data-name="th">
...
function Th1() {
  return (
    <div className="absolute bg-black h-[40.349px] left-[34.08px] top-0 w-[98.696px]" data-name="th">
...
function Th2() {
  return (
    <div className="absolute bg-black h-[40.349px] left-[132.78px] top-0 w-[127.532px]" data-name="th">
      <p className="-translate-x-full absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[119.79px] not-italic text-[#99a1af] text-[12px] text-right top-[12.71px]">Risk Amount</p>
    </div>
  );
}
...
function Th3() {
  return (
    <div className="absolute bg-black h-[40.349px] left-[260.31px] top-0 w-[104.949px]" data-name="th">
      <p className="-translate-x-full absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[97.02px] not-italic text-[#99a1af] text-[12px] text-right top-[12.71px]">P/L</p>
    </div>
  );
}
...
function Th4() {
  return (
    <div className="absolute bg-black h-[40.349px] left-[365.26px] top-0 w-[127.61px]" data-name="th">
      <p className="-translate-x-full absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[119.81px] not-italic text-[#99a1af] text-[12px] text-right top-[12.71px]">Capital After</p>
    </div>
  );
}
...
function Th5() {
  return (
    <div className="absolute bg-black h-[40.349px] left-[492.87px] top-0 w-[107.126px]" data-name="th">
      <p className="-translate-x-full absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[99.74px] not-italic text-[#99a1af] text-[12px] text-right top-[12.71px]">Time</p>
    </div>
  );
}
...
function MainContent() {
  return (
    <div className="bg-black h-[1793.119px] relative shrink-0 w-[393.148px]" data-name="Main Content">
...
function Container21() {
  return (
    <div className="content-stretch flex flex-col h-[88.697px] items-center justify-between pt-[32.703px] relative shrink-0 w-full" data-name="Container">
...
function Div() {
  return (
    <div className="bg-black content-stretch flex flex-col h-[2687.888px] items-start relative shrink-0 w-full" data-name="div">
      <MainContent />
      <Footer />
    </div>
  );
...
function Header() {
  return (
    <div className="absolute bg-[rgba(0,0,0,0.95)] content-stretch flex flex-col h-[64.7px] items-start left-[224.15px] pb-[0.707px] px-[15.998px] top-[77.78px] w-[393.148px]" data-name="header">
