import svgPaths from "./svg-hgoyq6ft1j";
...
function H() {
  return (
    <div className="h-[71.992px] relative shrink-0 w-full" data-name="h1">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[36px] left-0 not-italic text-[30px] text-white top-0 tracking-[0.3955px] w-[154px] whitespace-pre-wrap">GODZILLA Dashboard</p>
    </div>
  );
}
...
function P() {
  return (
    <div className="h-[23.997px] relative shrink-0 w-full" data-name="p">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#51a2ff] text-[16px] top-[-0.88px] tracking-[-0.3125px]">High Risk Growth Model</p>
    </div>
  );
}
...
function Container1() {
  return (
    <div className="h-[95.989px] relative shrink-0 w-[361.152px]" data-name="Container">
...
function BookOpen() {
  return (
    <div className="absolute left-[140.7px] size-[15.998px] top-[8px]" data-name="BookOpen">
...
function Button() {
  return (
    <div className="bg-white h-[31.996px] relative rounded-[8px] shrink-0 w-[361.152px]" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <BookOpen />
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[195.7px] not-italic text-[#51a2ff] text-[14px] text-center top-[6.41px] tracking-[-0.1504px]">Tutorial</p>
      </div>
    </div>
  );
}
...
function RotateCcw() {
  return (
    <div className="absolute left-[119.26px] size-[15.998px] top-[8px]" data-name="RotateCcw">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9982 15.9982">
        <g id="RotateCcw">
...
function Button1() {
  return (
    <div className="bg-white h-[31.996px] relative rounded-[8px] shrink-0 w-[361.152px]" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <RotateCcw />
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[195.75px] not-italic text-[#ff6467] text-[14px] text-center top-[6.41px] tracking-[-0.1504px]">Reset Session</p>
      </div>
    </div>
  );
}
...
function Container3() {
  return (
    <div className="h-[75.991px] relative shrink-0 w-[361.152px]" data-name="Container">
...
function Container() {
  return (
    <div className="content-stretch flex flex-col gap-[15.998px] h-[187.978px] items-start relative shrink-0 w-full" data-name="Container">
      <Container1 />
      <Container3 />
    </div>
  );
...
function P1() {
  return (
    <div className="absolute content-stretch flex h-[12.496px] items-start left-0 top-[24px] w-[102.585px]" data-name="p">
...
function P2() {
  return (
    <div className="absolute h-[27.997px] left-0 top-[40.49px] w-[102.585px]" data-name="p">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[28px] left-0 not-italic text-[20px] text-white top-[0.12px] tracking-[-0.4492px]">29</p>
    </div>
  );
}
...
function P3() {
  return (
    <div className="absolute h-[13.501px] left-0 top-[72.49px] w-[102.585px]" data-name="p">
...
function Div1() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[102.585px]" data-name="div">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Target />
        <P1 />
        <P2 />
...
function Card() {
  return (
    <div className="h-[111.401px] relative rounded-[14px] shrink-0 w-[127.996px]" data-name="Card" style={{ backgroundImage: "linear-gradient(138.965deg, rgba(43, 127, 255, 0.1) 0%, rgba(173, 70, 255, 0.1) 100%)" }}>
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pl-[12.706px] pr-[0.707px] py-[12.706px] relative size-full">
        <Div1 />
      </div>
    </div>
  );
...
function Card1() {
  return (
    <div className="h-[111.401px] relative rounded-[14px] shrink-0 w-[127.996px]" data-name="Card" style={{ backgroundImage: "linear-gradient(138.965deg, rgba(0, 201, 80, 0.1) 0%, rgba(0, 188, 125, 0.1) 100%)" }}>
...
function P8() {
  return (
    <div className="absolute h-[27.997px] left-0 top-[40.49px] w-[102.585px]" data-name="p">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[28px] left-0 not-italic text-[20px] text-white top-[0.12px] tracking-[-0.4492px]">100.0%</p>
    </div>
  );
}
...
function Card2() {
  return (
    <div className="h-[111.401px] relative rounded-[14px] shrink-0 w-[127.996px]" data-name="Card" style={{ backgroundImage: "linear-gradient(138.965deg, rgba(173, 70, 255, 0.1) 0%, rgba(246, 51, 154, 0.1) 100%)" }}>
...
function P11() {
  return (
    <div className="absolute h-[27.997px] left-0 top-[40.49px] w-[102.585px]" data-name="p">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[28px] left-0 not-italic text-[#05df72] text-[20px] top-[0.12px] tracking-[-0.4492px]">1</p>
    </div>
  );
}
...
function Card3() {
  return (
    <div className="h-[111.401px] relative rounded-[14px] shrink-0 w-[127.996px]" data-name="Card" style={{ backgroundImage: "linear-gradient(138.965deg, rgba(0, 201, 80, 0.1) 0%, rgba(0, 187, 167, 0.1) 100%)" }}>
      <div aria-hidden="true" className="absolute border-[0.707px] border-[rgba(0,201,80,0.3)] border-solid inset-0 pointer-events-none rounded-[14px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pl-[12.706px] pr-[0.707px] py-[12.706px] relative size-full">
        <Div4 />
      </div>
...
function Card4() {
  return (
    <div className="h-[111.401px] relative rounded-[14px] shrink-0 w-[127.996px]" data-name="Card" style={{ backgroundImage: "linear-gradient(138.965deg, rgba(251, 44, 54, 0.1) 0%, rgba(255, 105, 0, 0.1) 100%)" }}>
...
function P17() {
  return (
    <div className="absolute h-[23.997px] left-0 top-[40.49px] w-[102.585px]" data-name="p">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[24px] left-0 not-italic text-[16px] text-white top-[-0.88px] tracking-[-0.3125px]">₹10000</p>
    </div>
  );
}
...
function P18() {
  return (
    <div className="absolute h-[13.501px] left-0 overflow-clip top-[68.49px] w-[102.585px]" data-name="p">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[13.5px] left-0 not-italic text-[#6a7282] text-[9px] top-[0.41px] tracking-[0.167px]">Reserved</p>
    </div>
  );
}
...
function Div6() {
  return (
    <div className="h-[81.991px] relative shrink-0 w-[102.585px]" data-name="div">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <DollarSign />
        <P16 />
        <P17 />
...
function Card5() {
  return (
    <div className="h-[111.401px] relative rounded-[14px] shrink-0 w-[127.996px]" data-name="Card" style={{ backgroundImage: "linear-gradient(138.965deg, rgba(240, 177, 0, 0.1) 0%, rgba(255, 105, 0, 0.1) 100%)" }}>
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[0.707px] pl-[12.706px] pr-[0.707px] pt-[12.706px] relative size-full">
        <Div6 />
      </div>
    </div>
  );
...
function Container4() {
  return (
    <div className="content-stretch flex gap-[11.999px] h-[119.401px] items-start overflow-clip relative shrink-0 w-full" data-name="Container">
      <Card />
      <Card1 />
      <Card2 />
      <Card3 />
...
function H1() {
  return (
    <div className="h-[27.997px] relative shrink-0 w-[133.465px]" data-name="h2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[28px] left-0 not-italic text-[20px] text-white top-[0.12px] tracking-[-0.4492px]">Execute Trade</p>
      </div>
    </div>
  );
}
...
function Div7() {
  return (
    <div className="h-[27.997px] relative shrink-0 w-[568.001px]" data-name="div">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-between pr-[434.535px] relative size-full">
        <H1 />
      </div>
    </div>
  );
...
function Label() {
  return (
    <div className="absolute h-[19.998px] left-0 top-0 w-[568.001px]" data-name="label">
...
function P19() {
  return (
    <div className="h-[31.996px] relative shrink-0 w-[121.699px]" data-name="p">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[32px] left-0 not-italic text-[24px] text-white top-[-0.59px] tracking-[0.0703px]">₹10170.00</p>
      </div>
    </div>
  );
}
...
function Container7() {
  return (
    <div className="absolute bg-[#101828] content-stretch flex flex-col h-[57.408px] items-start left-0 pb-[0.707px] pt-[12.706px] px-[16.705px] rounded-[10px] top-[28px] w-[568.001px]" data-name="Container">
...
function P20() {
  return (
    <div className="absolute h-[15.998px] left-0 top-[89.4px] w-[568.001px]" data-name="p">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic text-[#6a7282] text-[12px] top-[0.71px]">Updates with each trade</p>
    </div>
  );
}
...
function Container6() {
  return (
    <div className="h-[105.402px] relative shrink-0 w-full" data-name="Container">
      <Label />
      <Container7 />
      <P20 />
    </div>
...
function Input() {
  return (
    <div className="absolute bg-[#101828] h-[49.409px] left-0 rounded-[10px] top-[28px] w-[568.001px]" data-name="input">
...
function P21() {
  return (
    <div className="absolute h-[15.998px] left-0 top-[81.4px] w-[568.001px]" data-name="p">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic text-[#6a7282] text-[12px] top-[0.71px]">Locked during session</p>
    </div>
  );
}
...
function P22() {
  return (
    <div className="h-[31.996px] relative shrink-0 w-full" data-name="p">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[32px] left-0 not-italic text-[24px] text-white top-[-0.59px] tracking-[0.0703px]">₹203.40</p>
    </div>
  );
}
...
function P23() {
  return (
    <div className="h-[15.998px] relative shrink-0 w-full" data-name="p">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic text-[#51a2ff] text-[12px] top-[0.71px]">Automatically calculated as 2% of current capital</p>
    </div>
  );
}
...
function Container11() {
  return (
    <div className="bg-[rgba(43,127,255,0.1)] h-[77.405px] relative rounded-[10px] shrink-0 w-full" data-name="Container">
...
function Container10() {
  return (
    <div className="content-stretch flex flex-col gap-[7.999px] h-[105.402px] items-start relative shrink-0 w-full" data-name="Container">
      <Label2 />
      <Container11 />
    </div>
  );
...
function TrendingUp1() {
  return (
    <div className="absolute left-[88.7px] size-[15.998px] top-[16px]" data-name="TrendingUp">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9982 15.9982">
...
function Button2() {
  return (
    <div className="absolute bg-[#00a63e] h-[47.994px] left-0 rounded-[8px] top-0 w-[276.001px]" data-name="Button">
      <TrendingUp1 />
      <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[154.19px] not-italic text-[14px] text-center text-white top-[14.41px] tracking-[-0.1504px]">Win Trade</p>
    </div>
  );
}
...
function TrendingDown1() {
  return (
    <div className="absolute left-[86.12px] size-[15.998px] top-[16px]" data-name="TrendingDown">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9982 15.9982">
...
function Button3() {
  return (
    <div className="absolute bg-[#e7000b] h-[47.994px] left-[292px] rounded-[8px] top-0 w-[276.001px]" data-name="Button">
      <TrendingDown1 />
      <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[154.62px] not-italic text-[14px] text-center text-white top-[14.41px] tracking-[-0.1504px]">Loss Trade</p>
    </div>
  );
}
...
function Div8() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[568.001px]" data-name="div">
...
function Card6() {
  return (
    <div className="absolute bg-black content-stretch flex flex-col gap-[47.994px] h-[605.587px] items-start left-0 pl-[16.705px] pr-[0.707px] py-[16.705px] rounded-[14px] top-0 w-[601.411px]" data-name="Card">
...
function H2() {
  return (
    <div className="absolute h-[27.997px] left-[16px] top-[16px] w-[568.001px]" data-name="h2">
...
function Td() {
  return (
    <div className="absolute h-[48.702px] left-0 top-0 w-[33.919px]" data-name="td">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[8px] not-italic text-[#d1d5dc] text-[14px] top-[14.77px] tracking-[-0.1504px]">1</p>
    </div>
  );
}
...
function TrendingUp2() {
  return (
    <div className="relative shrink-0 size-[11.999px]" data-name="TrendingUp">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11.9986 11.9986">
        <g clipPath="url(#clip0_210_747)" id="TrendingUp">
          <path d={svgPaths.p33066180} id="Vector" stroke="var(--stroke-0, #05DF72)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.999884" />
          <path d={svgPaths.pd48fb80} id="Vector_2" stroke="var(--stroke-0, #05DF72)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.999884" />
        </g>
        <defs>
...
function Span2() {
  return (
    <div className="h-[15.998px] relative shrink-0 w-[24.682px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16px] left-0 not-italic text-[#05df72] text-[12px] top-[0.71px]">WIN</p>
      </div>
    </div>
  );
}
...
function Div10() {
  return (
    <div className="absolute content-stretch flex gap-[4px] h-[15.998px] items-center left-[8px] top-[16.35px] w-[82.2px]" data-name="div">
      <TrendingUp2 />
      <Span2 />
    </div>
  );
...
function Td1() {
  return (
    <div className="absolute h-[48.702px] left-[33.92px] top-0 w-[98.199px]" data-name="td">
      <Div10 />
    </div>
  );
}
...
function Td2() {
  return (
    <div className="absolute h-[48.702px] left-[132.12px] top-0 w-[126.891px]" data-name="td">
      <p className="-translate-x-full absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-[119.22px] not-italic text-[12px] text-right text-white top-[17.06px]">₹200.00</p>
    </div>
  );
}
...
function Td3() {
  return (
    <div className="absolute h-[48.702px] left-[259.01px] top-0 w-[104.43px]" data-name="td">
      <p className="-translate-x-full absolute font-['Inter:Bold',sans-serif] font-bold leading-[16px] left-[97.4px] not-italic text-[#05df72] text-[12px] text-right top-[15.72px]">+₹170.00</p>
    </div>
  );
}
...
function Td4() {
  return (
    <div className="absolute h-[48.702px] left-[363.44px] top-0 w-[126.969px]" data-name="td">
      <p className="-translate-x-full absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[119.07px] not-italic text-[12px] text-right text-white top-[17.06px]">₹10170.00</p>
    </div>
  );
}
...
function Td5() {
  return (
    <div className="absolute h-[48.702px] left-[490.41px] top-0 w-[109.59px]" data-name="td">
      <p className="-translate-x-full absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-[101.97px] not-italic text-[#99a1af] text-[12px] text-right top-[17.06px]">1:16:18 PM</p>
    </div>
  );
}
...
function Tr() {
  return (
    <div className="absolute border-[#1e2939] border-b-[0.707px] border-solid h-[48.702px] left-0 top-0 w-[599.997px]" data-name="tr">
      <Td />
      <Td1 />
      <Td2 />
      <Td3 />
...
function Tbody() {
  return (
    <div className="absolute h-[48.702px] left-0 top-[40.35px] w-[599.997px]" data-name="tbody">
      <Tr />
    </div>
  );
}
...
function Table() {
  return (
    <div className="absolute h-[89.404px] left-0 top-0 w-[599.997px]" data-name="table">
      <Tbody />
    </div>
  );
}
...
function Th() {
  return (
    <div className="absolute bg-black h-[40.349px] left-0 top-0 w-[33.919px]" data-name="th">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[8px] not-italic text-[#99a1af] text-[12px] top-[12.71px]">#</p>
    </div>
  );
}
...
function Th1() {
  return (
    <div className="absolute bg-black h-[40.349px] left-[33.92px] top-0 w-[98.199px]" data-name="th">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[8px] not-italic text-[#99a1af] text-[12px] top-[12.71px]">Outcome</p>
    </div>
  );
}
...
function Th2() {
  return (
    <div className="absolute bg-black h-[40.349px] left-[132.12px] top-0 w-[126.891px]" data-name="th">
      <p className="-translate-x-full absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[119.15px] not-italic text-[#99a1af] text-[12px] text-right top-[12.71px]">Risk Amount</p>
    </div>
  );
}
...
function Th3() {
  return (
    <div className="absolute bg-black h-[40.349px] left-[259.01px] top-0 w-[104.43px]" data-name="th">
      <p className="-translate-x-full absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[96.5px] not-italic text-[#99a1af] text-[12px] text-right top-[12.71px]">P/L</p>
    </div>
  );
}
...
function Th4() {
  return (
    <div className="absolute bg-black h-[40.349px] left-[363.44px] top-0 w-[126.969px]" data-name="th">
      <p className="-translate-x-full absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[119.17px] not-italic text-[#99a1af] text-[12px] text-right top-[12.71px]">Capital After</p>
    </div>
  );
}
...
function Th5() {
  return (
    <div className="absolute bg-black h-[40.349px] left-[490.41px] top-0 w-[109.59px]" data-name="th">
      <p className="-translate-x-full absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[102.21px] not-italic text-[#99a1af] text-[12px] text-right top-[12.71px]">Time</p>
    </div>
  );
}
...
function Tr1() {
  return (
    <div className="absolute border-[#1e2939] border-b-[0.707px] border-solid h-[40.349px] left-0 top-0 w-[599.997px]" data-name="tr">
      <Th />
      <Th1 />
      <Th2 />
      <Th3 />
...
function Thead() {
  return (
    <div className="absolute bg-black h-[40.349px] left-0 top-0 w-[599.997px]" data-name="thead">
      <Tr1 />
    </div>
  );
}
...
function Div9() {
  return (
    <div className="absolute h-[89.404px] left-0 overflow-clip top-[91.99px] w-[599.997px]" data-name="div">
      <Table />
      <Thead />
    </div>
  );
...
function Card7() {
  return (
    <div className="absolute bg-black border-[#1e2939] border-[0.707px] border-solid h-[198.806px] left-0 rounded-[14px] top-[637.58px] w-[601.411px]" data-name="Card">
      <H2 />
      <Div9 />
    </div>
  );
...
function Container5() {
  return (
    <div className="h-[836.389px] relative shrink-0 w-full" data-name="Container">
      <Card6 />
      <Card7 />
    </div>
  );
...
function Div11() {
  return (
    <div className="h-[31.996px] relative shrink-0 w-[327.741px]" data-name="div">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[11.999px] items-center relative size-full">
        <History />
        <H3 />
      </div>
...
function History1() {
  return (
    <div className="absolute left-[131.87px] size-[63.993px] top-[47.99px]" data-name="History">
...
function P25() {
  return (
    <div className="absolute h-[23.997px] left-0 top-[127.99px] w-[327.741px]" data-name="p">
      <p className="-translate-x-1/2 absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-[164.64px] not-italic text-[#6a7282] text-[16px] text-center top-[-0.88px] tracking-[-0.3125px]">No completed sessions yet</p>
    </div>
  );
}
...
function P26() {
  return (
    <div className="absolute h-[39.995px] left-0 top-[159.98px] w-[327.741px]" data-name="p">
      <p className="-translate-x-1/2 absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[164px] not-italic text-[#4a5565] text-[14px] text-center top-[0.41px] tracking-[-0.1504px] w-[281px] whitespace-pre-wrap">Complete your first 30-trade session to see history</p>
    </div>
  );
}
...
function Div12() {
  return (
    <div className="h-[247.971px] relative shrink-0 w-[327.741px]" data-name="div">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <History1 />
        <P25 />
        <P26 />
...
function Card8() {
  return (
    <div className="bg-black h-[361.373px] relative rounded-[14px] shrink-0 w-full" data-name="Card">
      <div aria-hidden="true" className="absolute border-[#1e2939] border-[0.707px] border-solid inset-0 pointer-events-none rounded-[14px]" />
      <div className="content-stretch flex flex-col gap-[47.994px] items-start pb-[0.707px] pl-[16.705px] pr-[0.707px] pt-[16.705px] relative size-full">
        <Div11 />
        <Div12 />
      </div>
    </div>
...
function MainContent() {
  return (
    <div className="bg-black h-[1761.122px] relative shrink-0 w-[393.148px]" data-name="Main Content">
...
function Link5() {
  return (
    <div className="h-[19.998px] relative shrink-0 w-[108.44px]" data-name="Link">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Div() {
  return (
    <div className="bg-black content-stretch flex flex-col h-[2655.892px] items-start relative shrink-0 w-full" data-name="div">
      <MainContent />
      <Footer />
    </div>
  );
...
function Header() {
  return (
    <div className="absolute bg-[rgba(0,0,0,0.95)] content-stretch flex flex-col h-[64.7px] items-start left-[224.15px] pb-[0.707px] px-[15.998px] top-[210.72px] w-[393.148px]" data-name="header">
