import svgPaths from "./svg-577ezgeo9d";
...
function H() {
  return (
    <div className="absolute h-[79.991px] left-0 top-0 w-[183.437px]" data-name="h1">
...
function P() {
  return (
    <div className="absolute h-[55.994px] left-0 top-[79.99px] w-[183.437px]" data-name="p">
...
function Button1() {
  return (
    <div className="bg-white h-[31.996px] relative rounded-[8px] shrink-0 w-[144.05px]" data-name="Button">
...
function Td() {
  return (
    <div className="absolute h-[48.702px] left-0 top-0 w-[33.024px]" data-name="td">
...
function Div10() {
  return (
    <div className="absolute content-stretch flex gap-[4px] h-[15.998px] items-center left-[8px] top-[16.35px] w-[79.637px]" data-name="div">
      <TrendingUp2 />
      <Span2 />
    </div>
  );
...
function Td1() {
  return (
    <div className="absolute h-[48.702px] left-[33.02px] top-0 w-[95.635px]" data-name="td">
      <Div10 />
    </div>
  );
}
...
function Td2() {
  return (
    <div className="absolute h-[48.702px] left-[128.66px] top-0 w-[123.577px]" data-name="td">
      <p className="-translate-x-full absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-[115.9px] not-italic text-[12px] text-right text-white top-[17.06px]">₹200.00</p>
    </div>
  );
}
...
function Td3() {
  return (
    <div className="absolute h-[48.702px] left-[252.24px] top-0 w-[101.701px]" data-name="td">
      <p className="-translate-x-full absolute font-['Inter:Bold',sans-serif] font-bold leading-[16px] left-[94.67px] not-italic text-[#05df72] text-[12px] text-right top-[15.72px]">+₹170.00</p>
    </div>
  );
}
...
function Td4() {
  return (
    <div className="absolute h-[48.702px] left-[353.94px] top-0 w-[123.654px]" data-name="td">
      <p className="-translate-x-full absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[115.75px] not-italic text-[12px] text-right text-white top-[17.06px]">₹10170.00</p>
    </div>
  );
}
...
function Td5() {
  return (
    <div className="absolute h-[48.702px] left-[477.59px] top-0 w-[122.406px]" data-name="td">
      <p className="-translate-x-full absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-[114.54px] not-italic text-[#99a1af] text-[12px] text-right top-[17.06px]">12:56:09 PM</p>
    </div>
  );
}
...
function Th() {
  return (
    <div className="absolute bg-black h-[40.349px] left-0 top-0 w-[33.024px]" data-name="th">
...
function Th1() {
  return (
    <div className="absolute bg-black h-[40.349px] left-[33.02px] top-0 w-[95.635px]" data-name="th">
...
function Th2() {
  return (
    <div className="absolute bg-black h-[40.349px] left-[128.66px] top-0 w-[123.577px]" data-name="th">
      <p className="-translate-x-full absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[115.83px] not-italic text-[#99a1af] text-[12px] text-right top-[12.71px]">Risk Amount</p>
    </div>
  );
}
...
function Th3() {
  return (
    <div className="absolute bg-black h-[40.349px] left-[252.24px] top-0 w-[101.701px]" data-name="th">
      <p className="-translate-x-full absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[93.77px] not-italic text-[#99a1af] text-[12px] text-right top-[12.71px]">P/L</p>
    </div>
  );
}
...
function Th4() {
  return (
    <div className="absolute bg-black h-[40.349px] left-[353.94px] top-0 w-[123.654px]" data-name="th">
      <p className="-translate-x-full absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[115.86px] not-italic text-[#99a1af] text-[12px] text-right top-[12.71px]">Capital After</p>
    </div>
  );
}
...
function Th5() {
  return (
    <div className="absolute bg-black h-[40.349px] left-[477.59px] top-0 w-[122.406px]" data-name="th">
      <p className="-translate-x-full absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[115.02px] not-italic text-[#99a1af] text-[12px] text-right top-[12.71px]">Time</p>
    </div>
  );
}
...
function MainContent() {
  return (
    <div className="bg-black h-[1892.521px] relative shrink-0 w-[393.148px]" data-name="Main Content">
...
function Div() {
  return (
    <div className="bg-black content-stretch flex flex-col h-[2787.291px] items-start relative shrink-0 w-full" data-name="div">
      <MainContent />
      <Footer />
    </div>
  );
...
function Header() {
  return (
    <div className="absolute bg-[rgba(0,0,0,0.95)] content-stretch flex flex-col h-[64.7px] items-start left-[224.15px] pb-[0.707px] px-[15.998px] top-[690.13px] w-[393.148px]" data-name="header">
