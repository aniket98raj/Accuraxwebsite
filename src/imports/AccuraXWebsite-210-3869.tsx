import svgPaths from "./svg-neksgddvdi";
...
function Td() {
  return (
    <div className="absolute h-[48.702px] left-0 top-0 w-[33.598px]" data-name="td">
...
function Div10() {
  return (
    <div className="absolute content-stretch flex gap-[4px] h-[15.998px] items-center left-[8px] top-[16.35px] w-[81.283px]" data-name="div">
      <TrendingUp2 />
      <Span2 />
    </div>
  );
...
function Td1() {
  return (
    <div className="absolute h-[48.702px] left-[33.6px] top-0 w-[97.282px]" data-name="td">
      <Div10 />
    </div>
  );
}
...
function Td2() {
  return (
    <div className="absolute h-[48.702px] left-[130.88px] top-0 w-[125.709px]" data-name="td">
      <p className="-translate-x-full absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-[118.04px] not-italic text-[12px] text-right text-white top-[17.06px]">₹200.00</p>
    </div>
  );
}
...
function Td3() {
  return (
    <div className="absolute h-[48.702px] left-[256.59px] top-0 w-[103.447px]" data-name="td">
      <p className="-translate-x-full absolute font-['Inter:Bold',sans-serif] font-bold leading-[16px] left-[96.42px] not-italic text-[#05df72] text-[12px] text-right top-[15.72px]">+₹170.00</p>
    </div>
  );
}
...
function Td4() {
  return (
    <div className="absolute h-[48.702px] left-[360.04px] top-0 w-[125.787px]" data-name="td">
      <p className="-translate-x-full absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[117.88px] not-italic text-[12px] text-right text-white top-[17.06px]">₹10170.00</p>
    </div>
  );
}
...
function Td5() {
  return (
    <div className="absolute h-[48.702px] left-[485.82px] top-0 w-[114.175px]" data-name="td">
      <p className="-translate-x-full absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-[106.6px] not-italic text-[#99a1af] text-[12px] text-right top-[17.06px]">1:09:09 PM</p>
    </div>
  );
}
...
function Th() {
  return (
    <div className="absolute bg-black h-[40.349px] left-0 top-0 w-[33.598px]" data-name="th">
...
function Th1() {
  return (
    <div className="absolute bg-black h-[40.349px] left-[33.6px] top-0 w-[97.282px]" data-name="th">
...
function Th2() {
  return (
    <div className="absolute bg-black h-[40.349px] left-[130.88px] top-0 w-[125.709px]" data-name="th">
      <p className="-translate-x-full absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[117.97px] not-italic text-[#99a1af] text-[12px] text-right top-[12.71px]">Risk Amount</p>
    </div>
  );
}
...
function Th3() {
  return (
    <div className="absolute bg-black h-[40.349px] left-[256.59px] top-0 w-[103.447px]" data-name="th">
      <p className="-translate-x-full absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[95.52px] not-italic text-[#99a1af] text-[12px] text-right top-[12.71px]">P/L</p>
    </div>
  );
}
...
function Th4() {
  return (
    <div className="absolute bg-black h-[40.349px] left-[360.04px] top-0 w-[125.787px]" data-name="th">
      <p className="-translate-x-full absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[117.99px] not-italic text-[#99a1af] text-[12px] text-right top-[12.71px]">Capital After</p>
    </div>
  );
}
...
function Th5() {
  return (
    <div className="absolute bg-black h-[40.349px] left-[485.82px] top-0 w-[114.175px]" data-name="th">
      <p className="-translate-x-full absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[106.79px] not-italic text-[#99a1af] text-[12px] text-right top-[12.71px]">Time</p>
    </div>
  );
}
...
function Header() {
  return (
    <div className="absolute bg-[rgba(0,0,0,0.95)] content-stretch flex flex-col h-[64.7px] items-start left-[224.15px] pb-[0.707px] px-[15.998px] top-[698.62px] w-[393.148px]" data-name="header">
