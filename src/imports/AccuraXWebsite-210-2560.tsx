import svgPaths from "./svg-fbrru4e1mr";
...
function Div8() {
  return (
    <div className="h-[504.185px] relative shrink-0 w-[295.745px]" data-name="div">
...
function Card6() {
  return (
    <div className="absolute bg-black content-stretch flex flex-col gap-[47.994px] h-[649.582px] items-start left-0 pb-[0.707px] pl-[32.703px] pr-[0.707px] pt-[32.703px] rounded-[14px] top-0 w-[361.152px]" data-name="Card">
...
function Header() {
  return (
    <div className="absolute bg-[rgba(0,0,0,0.95)] content-stretch flex flex-col h-[64.7px] items-start left-[135.76px] pb-[0.707px] px-[15.998px] top-[2.83px] w-[393.148px]" data-name="header">
