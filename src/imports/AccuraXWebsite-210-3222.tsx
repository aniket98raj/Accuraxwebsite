import svgPaths from "./svg-4ycwaxh6px";
...
function H() {
  return (
    <div className="absolute h-[71.992px] left-0 top-0 w-[301.07px]" data-name="h1">
...
function P() {
  return (
    <div className="absolute h-[23.997px] left-0 top-[71.99px] w-[301.07px]" data-name="p">
...
function Div7() {
  return (
    <div className="h-[31.996px] relative shrink-0 w-[536.004px]" data-name="div">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-between pr-[377.382px] relative size-full">
        <H1 />
      </div>
    </div>
  );
...
function Label() {
  return (
    <div className="absolute h-[19.998px] left-0 top-0 w-[536.004px]" data-name="label">
...
function Container7() {
  return (
    <div className="absolute bg-[#101828] content-stretch flex flex-col h-[57.408px] items-start left-0 pb-[0.707px] pt-[12.706px] px-[16.705px] rounded-[10px] top-[28px] w-[536.004px]" data-name="Container">
...
function P20() {
  return (
    <div className="absolute h-[15.998px] left-0 top-[89.4px] w-[536.004px]" data-name="p">
...
function Input() {
  return (
    <div className="absolute bg-[#101828] h-[49.409px] left-0 rounded-[10px] top-[28px] w-[536.004px]" data-name="input">
...
function P21() {
  return (
    <div className="absolute h-[15.998px] left-0 top-[81.4px] w-[536.004px]" data-name="p">
...
function TrendingUp1() {
  return (
    <div className="absolute left-[80.7px] size-[15.998px] top-[16px]" data-name="TrendingUp">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9982 15.9982">
...
function Button2() {
  return (
    <div className="absolute bg-[#00a63e] h-[47.994px] left-0 rounded-[8px] top-0 w-[260.003px]" data-name="Button">
      <TrendingUp1 />
      <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[146.19px] not-italic text-[14px] text-center text-white top-[14.41px] tracking-[-0.1504px]">Win Trade</p>
    </div>
  );
}
...
function TrendingDown1() {
  return (
    <div className="absolute left-[78.12px] size-[15.998px] top-[16px]" data-name="TrendingDown">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9982 15.9982">
...
function Button3() {
  return (
    <div className="absolute bg-[#e7000b] h-[47.994px] left-[276px] rounded-[8px] top-0 w-[260.003px]" data-name="Button">
      <TrendingDown1 />
      <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[146.62px] not-italic text-[14px] text-center text-white top-[14.41px] tracking-[-0.1504px]">Loss Trade</p>
    </div>
  );
}
...
function Div8() {
  return (
    <div className="h-[496.186px] relative shrink-0 w-[536.004px]" data-name="div">
...
function Card6() {
  return (
    <div className="absolute bg-black content-stretch flex flex-col gap-[47.994px] h-[641.583px] items-start left-0 pb-[0.707px] pl-[32.703px] pr-[0.707px] pt-[32.703px] rounded-[14px] top-0 w-[601.411px]" data-name="Card">
...
function Td() {
  return (
    <div className="absolute h-[48.702px] left-0 top-0 w-[33.676px]" data-name="td">
...
function Div10() {
  return (
    <div className="absolute content-stretch flex gap-[4px] h-[15.998px] items-center left-[8px] top-[16.35px] w-[81.515px]" data-name="div">
      <TrendingUp2 />
      <Span2 />
    </div>
  );
...
function Td1() {
  return (
    <div className="absolute h-[48.702px] left-[33.68px] top-0 w-[97.514px]" data-name="td">
      <Div10 />
    </div>
  );
}
...
function Td2() {
  return (
    <div className="absolute h-[48.702px] left-[131.19px] top-0 w-[126.008px]" data-name="td">
      <p className="-translate-x-full absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-[118.33px] not-italic text-[12px] text-right text-white top-[17.06px]">₹200.00</p>
    </div>
  );
}
...
function Td3() {
  return (
    <div className="absolute h-[48.702px] left-[257.2px] top-0 w-[103.69px]" data-name="td">
      <p className="-translate-x-full absolute font-['Inter:Bold',sans-serif] font-bold leading-[16px] left-[96.66px] not-italic text-[#05df72] text-[12px] text-right top-[15.72px]">+₹170.00</p>
    </div>
  );
}
...
function Td4() {
  return (
    <div className="absolute h-[48.702px] left-[360.89px] top-0 w-[126.085px]" data-name="td">
      <p className="-translate-x-full absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[118.18px] not-italic text-[12px] text-right text-white top-[17.06px]">₹10170.00</p>
    </div>
  );
}
...
function Td5() {
  return (
    <div className="absolute h-[48.702px] left-[486.97px] top-0 w-[113.026px]" data-name="td">
      <p className="-translate-x-full absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-[105.44px] not-italic text-[#99a1af] text-[12px] text-right top-[17.06px]">1:07:46 PM</p>
    </div>
  );
}
...
function Th() {
  return (
    <div className="absolute bg-black h-[40.349px] left-0 top-0 w-[33.676px]" data-name="th">
...
function Th1() {
  return (
    <div className="absolute bg-black h-[40.349px] left-[33.68px] top-0 w-[97.514px]" data-name="th">
...
function Th2() {
  return (
    <div className="absolute bg-black h-[40.349px] left-[131.19px] top-0 w-[126.008px]" data-name="th">
      <p className="-translate-x-full absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[118.27px] not-italic text-[#99a1af] text-[12px] text-right top-[12.71px]">Risk Amount</p>
    </div>
  );
}
...
function Th3() {
  return (
    <div className="absolute bg-black h-[40.349px] left-[257.2px] top-0 w-[103.69px]" data-name="th">
      <p className="-translate-x-full absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[95.76px] not-italic text-[#99a1af] text-[12px] text-right top-[12.71px]">P/L</p>
    </div>
  );
}
...
function Th4() {
  return (
    <div className="absolute bg-black h-[40.349px] left-[360.89px] top-0 w-[126.085px]" data-name="th">
      <p className="-translate-x-full absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[118.29px] not-italic text-[#99a1af] text-[12px] text-right top-[12.71px]">Capital After</p>
    </div>
  );
}
...
function Th5() {
  return (
    <div className="absolute bg-black h-[40.349px] left-[486.97px] top-0 w-[113.026px]" data-name="th">
      <p className="-translate-x-full absolute font-['Inter:Medium',sans-serif] font-medium leading-[16px] left-[105.64px] not-italic text-[#99a1af] text-[12px] text-right top-[12.71px]">Time</p>
    </div>
  );
}
...
function Card7() {
  return (
    <div className="absolute bg-black border-[#1e2939] border-[0.707px] border-solid h-[198.806px] left-0 rounded-[14px] top-[673.58px] w-[601.411px]" data-name="Card">
      <H2 />
      <Div9 />
    </div>
  );
...
function Container5() {
  return (
    <div className="h-[872.385px] relative shrink-0 w-full" data-name="Container">
      <Card6 />
      <Card7 />
    </div>
  );
...
function MainContent() {
  return (
    <div className="bg-black h-[1944.516px] relative shrink-0 w-[393.148px]" data-name="Main Content">
...
function Div() {
  return (
    <div className="bg-black content-stretch flex flex-col h-[2839.285px] items-start relative shrink-0 w-full" data-name="div">
      <MainContent />
      <Footer />
    </div>
  );
...
function Header() {
  return (
    <div className="absolute bg-[rgba(0,0,0,0.95)] content-stretch flex flex-col h-[64.7px] items-start left-[224.15px] pb-[0.707px] px-[15.998px] top-[1054.99px] w-[393.148px]" data-name="header">
